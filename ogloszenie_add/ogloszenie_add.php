...
<?php
			...
			<label  class="description">Dodaj zdjęcia:</label>
				<div class="prawa">
					...
					<div id="img_add">
						...
						<div id="img_div0"><input type="file" onChange="dodaj_img();"name="img0"/></div>
					</div>
					<div id="max_img">
					</div>
					<div id="ile_zdjec">
						<input type="hidden" name="ile_zdjec" value="0"/>
					</div>
	...
	odswiez_powiaty("<?php if(isset($_SESSION['fr_powiaty'])) echo $_SESSION['fr_powiaty'];?>","<?php if(isset($_SESSION['fr_miasto'])) echo $_SESSION['fr_miasto'];?>",0);
		<?php 
