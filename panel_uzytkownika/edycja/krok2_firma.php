<html lang="pl">
	...
	<body>
		<div class="edit_container2">
			...
			<form>
				<fieldset>
					<legend>Podstawowe informacje o twojej firmie</legend>
						<div class="edit_input">
							<label for="imie" class="edit_tytul">Nazwa Firmy: </label>
						...
						<div class="edit_input">
							<label for="miejscowosc" class="edit_tytul">Siedziba: </label>
						...
						<div class="edit_input">
							<label for="wiek" class="edit_tytul">Na rynku od: </label>
	...
	{ 
		...
		({  
			...
			data: {imie: imie, miejscowosc: miejscowosc, wiek: wiek, email: email, wojewodztwo: wojewodztwo}
		}).always(function()
			{
