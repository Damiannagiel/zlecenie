...
<?php
	...
	<div id="regulations">
            ...
            <ol>
                <li>Poprzez piki “cookies” należy rozumieć dane informatyczne przechowywane w urządzeniach końcowych użytkowników, przeznaczone do korzystania ze stron internetowych. W szczególności są to pliki tekstowe, zawierające nazwę strony internetowej, z której pochodzą, czas przechowywania ich na urządzeniu końcowym oraz unikalny numer.</li>
                <li>Serwis nie zbiera w sposób automatyczny żadnych informacji, z wyjątkiem informacji zawartych w plikach cookies.</li>
                <li>Pliki cookies przeznaczone są do korzystania ze stron serwisu. Administrator wykorzystuje te pliki do:
                    <ol>
                        <li class="lower-alpha">możliwości logowania i utrzymywania sesji użytkownika na każdej kolejnej stronie serwisu</li>
                        <li class="lower-alpha">dopasowania zawartości strony internetowej do indywidualnych preferencji użytkownika, przede wszystkim pliki te rozpoznają jego urządzenie, aby zgodnie z jego preferencjami wyświetlić stronę</li>
 	...
 	Przykładowe opcje edytowania w popularnych przeglądarkach:
                    <ol>
                        <li class="circle"><a target="blank" href="https://support.google.com/chrome/answer/95647?hl=pl">Google Chrome</a></li>
                        <li class="circle"><a target="blank" href="https://support.mozilla.org/pl/kb/W%C5%82%C4%85czanie%20i%20wy%C5%82%C4%85czanie%20obs%C5%82ugi%20ciasteczek">Mozilla Firefox</a></li>
                        <li class="circle"><a target="blank" href="https://support.microsoft.com/pl-pl/help/17442/windows-internet-explorer-delete-manage-cookies">Internet Explorer</a></li>
                        <li class="circle"><a target="blank" href="http://help.opera.com/Windows/12.10/pl/cookies.html">Opera</a></li>
