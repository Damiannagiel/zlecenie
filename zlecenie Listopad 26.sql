...
--
-- Host: 127.0.0.1
-- Czas generowania: 27 Lis 2017, 18:50
...
(39, 1, '2', '2017-10-31 07:35:18', '2017-11-14 07:35:18', 'kujawsko-pomorskie_Toruń', 'Toruń', 'lorem ipsum', 3, 'do edycji i usunięcia', 'Dom i ogród > Opieka > Dzieci', 1000, 'za usługę', 'lorem iipsum', 378956189, 'jacapno@wp.com', 'https://www.youtube.com/user/elw666', 10, 1, 1),
(41, 5, '1', '2017-11-26 15:33:08', '2017-12-10 15:33:08', 'lubelskie_Lublin', 'Lublin', 'Dom jednorodzinny dwukondygnacyjny, wolnostojący', 2, 'szukam sprzątaczki', 'Dom i ogród > Sprzątanie', 15, 'za godzinę', 'Szukam pani do sprzątania domu jednorodzinnego (ok 150m2) dwa razy w tygodniu, wtorki i piątki, pora do ustalenia', NULL, NULL, 'www.interia.pl', 15, 0, 2);
...
(1, 'jacan1989@gmail.com', 'jacapno', '$2y$10$uP1afhGY95vck9dpDmZlk.OwO.bWA8ksYs903I5eQ4e9KULf/RC6u', 'fb', '1', 3213907938, '2017-11-26'),
(2, 'ziomek123@wp.pl', 'Edek', '$2y$10$.3h8a0LEc8SSA5EGPN257e4O5aNombVBz77DigvZg754L9uzXXc2C', 'inne', '0', 2232267134, '2017-10-08'),
(4, 'damiannagiel24@wp.pl', 'czesiekhydraulik', '$2y$10$aiI3C732TsYccr3HaE4/cOER0gd3UxwZ27NFs3T4QekiwUX2A1ure', 'polecenie', '0', 2693750403, '2017-11-23'),
(5, 'monisia22666@wp.pl', 'mondzia', '$2y$10$TEeihWpq0NA8unFuOfj7m.x164LM2l7CbWIC0CpvsdCCMh8LzyrXa', 'fb', '0', 3385640958, '2017-11-26'),
(10, 'ziomek334@wp.pl', 'damian_pno', '$2y$10$fe.rsjFb7FoRjmaPeGRCcemB2Xm.L.jJarS2XQvpBpr6kstNGGeI.', 'polecenie', '1', 1730420695, '2017-11-24'),
